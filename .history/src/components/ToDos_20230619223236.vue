...
<template>
  <div class="todo-container w3-white w3-card-4">
    ...
    <!-- Remove & Add Buttons -->
    <div class="w3-container w3-twothird w3-light-gray w3-padding">
      <input
      ...
      />
      <button class="w3-button w3-third w3-gray" @click="clearToDo()">
        <i class="fa-solid fa-times"></i>
      </button>
    </div>

    <div class="w3-container flex-container w3-light-gray w3-padding w3-center">
